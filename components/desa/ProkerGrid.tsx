...
interface ProkerGridProps {
  articles: Article[]
}

export default function ProkerGrid({ articles }: ProkerGridProps) {
  ...
  return (
    <section className="py-16 bg-surface">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <SectionTitle title="Program Kerja" subtitle="Program kerja yang kami jalankan di desa ini." />
        </div>
