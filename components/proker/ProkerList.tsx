        ...
        >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-4 pr-8 py-2 rounded-full border border-border bg-surface text-text text-sm focus:outline-none focus:border-primary transition-colors cursor-pointer"
            >
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            {filtered.map((article) => (
              <motion.div key={article.slug} className="relative group" variants={cardVariants} layout exit={{ opacity: 0, scale: 0.95, transition: { duration: 0.2 } }}>
